...
But we will focus on JQuery for one important reason.  It works with HTML5 and together with HTML, CSS and JQuery, we can create some pretty amazing client-side applications with JQuery.
